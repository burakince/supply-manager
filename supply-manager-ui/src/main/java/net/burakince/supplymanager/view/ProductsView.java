...
import net.burakince.supplymanager.ResetButtonForTextField;
import net.burakince.supplymanager.backend.DataService;
import net.burakince.supplymanager.backend.data.Product;
import net.burakince.supplymanager.dao.DaoLogic;
import net.burakince.supplymanager.dao.ProductForm;
import net.burakince.supplymanager.dao.ProductGrid;
 ...
 *
 * See also {@link DaoLogic} for fetching the data, the actual CRUD
...
public class ProductsView extends CssLayout implements View {
	...
	private DaoLogic viewLogic = new DaoLogic(this);
