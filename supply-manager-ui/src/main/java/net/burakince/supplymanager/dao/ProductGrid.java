...
import net.burakince.supplymanager.backend.data.Availability;
...
public class ProductGrid extends Grid {
	...
	private StringToEnumConverter availabilityConverter = new StringToEnumConverter() {
		...
		@Override
		public String convertToPresentation(Enum availability, Class<? extends String> targetType, Locale locale) throws ConversionException {
	...
	public ProductGrid() {
		...
		setCellStyleGenerator(new CellStyleGenerator() {
			...
			public String getStyle(CellReference cellReference) {
				if ("price".equals(cellReference.getPropertyId()) || "stockCount".equals(cellReference.getPropertyId())) {
					return "align-right";
				}
				return null;
			}
