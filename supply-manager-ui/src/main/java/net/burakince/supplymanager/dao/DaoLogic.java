package net.burakince.supplymanager.dao;
...
import net.burakince.supplymanager.view.ProductsView;
...
public class DaoLogic {
	...
	public DaoLogic(ProductsView simpleCrudView) {
		view = simpleCrudView;
	}
	...
	public void init() {
		...
		if (!SupplyManagerUI.get().getAccessControl().isUserInRole("admin")) {
	...
	private void setFragmentParameter(String productId) {
		...
		Page page = SupplyManagerUI.get().getPage();
		page.setUriFragment("!" + ProductsView.VIEW_NAME + "/" + fragmentParameter, false);
	}
